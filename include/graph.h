...
/**
 * Create a MST using Prim's algorithm and a binary min heap, and save it to a
 * file if filename is not empty
 * @param graph
 * @param filename
 * @note Running time of this function is O(log n) where n is the number of
 * vertices.
 * @return parent array
 */
