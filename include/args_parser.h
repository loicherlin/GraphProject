...
static char doc[] =
    "Give the Minimum Spanning Tree based on input file (normaly Tree's of "
...
static struct argp_option options[] = {
    ...
    {"delimiter", 'd', "DELIMITER", 0,
     "Delimiter for parsing input file. Default is ';'.", 0},
    {"load delaunay", 'l', "BINARY_FILE", 0,
     "Load delaunay triangles from binary file.", 0},
    {"save delaunay", 's', "PATH", 0, "Save delaunay triangles to binary file.",
     0},
    {"save mst", 'm', "PATH", 0,
     "Save mst to plain txt file with \"org - dest\" convention.", 0},
    {"visualise", 'v', 0, 0, "Visualise the result.", 0},
    {"height", 'h', "HEIGHT", 0,
     "Height of the visualisation window. (default 900)", 0},
    {"width", 'w', "WIDTH", 0,
     "Width of the visualisation window. (default 1400)", 0},
    {0}};
