...
int compare_triangle_point(triangle_t a, triangle_t b, double EPSILON) {
    return (compare_data_t(a.s1, b.s1, EPSILON) ||
            compare_data_t(a.s1, b.s2, EPSILON) ||
            compare_data_t(a.s1, b.s3, EPSILON) ||
            compare_data_t(a.s2, b.s1, EPSILON) ||
            compare_data_t(a.s2, b.s2, EPSILON) ||
            compare_data_t(a.s2, b.s3, EPSILON) ||
            compare_data_t(a.s3, b.s1, EPSILON) ||
            compare_data_t(a.s3, b.s2, EPSILON) ||
