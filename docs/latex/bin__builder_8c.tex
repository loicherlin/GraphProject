\hypertarget{bin__builder_8c}{}\doxysection{src/bin\+\_\+builder.c File Reference}
\label{bin__builder_8c}\index{src/bin\_builder.c@{src/bin\_builder.c}}
...
Include dependency graph for bin\+\_\+builder.\+c\+:
% FIG 0
\doxysubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{bin__builder_8c_a3dc244c07dbb044c301d271d33c4d4ab}{sanatize\+\_\+coordinates}} (double $\ast$lattitude, double $\ast$longitude, char $\ast$coordinates)
\item 
int \mbox{\hyperlink{bin__builder_8c_a4049baa165aaf59a7374b2a1eb72bbf4}{write\+\_\+to\+\_\+csv\+\_\+bin}} (char $\ast$$\ast$contents, FILE $\ast$fp\+\_\+bin, int n)
\item 
bool \mbox{\hyperlink{bin__builder_8c_a18afdb04b391d886f6f9305aa7281eb9}{is\+\_\+empty\+\_\+line}} (FILE $\ast$fp)
\item 
int \mbox{\hyperlink{bin__builder_8c_a9740c6a3456e81349f44221bf6f1a099}{build\+\_\+csv\+\_\+bin}} (FILE $\ast$fp, char $\ast$path\+\_\+bin, char delimiter)
\item 
\mbox{\hyperlink{array__list_8h_a15376354e4e8b4f1732e9df17f30786c}{list\+\_\+t}} $\ast$ \mbox{\hyperlink{bin__builder_8c_a72af491dba4bd97700b63f8dc347d767}{get\+\_\+data\+\_\+csv\+\_\+bin}} (FILE $\ast$fp)
\end{DoxyCompactItemize}


\doxysubsection{Function Documentation}
\mbox{\Hypertarget{bin__builder_8c_a9740c6a3456e81349f44221bf6f1a099}\label{bin__builder_8c_a9740c6a3456e81349f44221bf6f1a099}} 
\index{bin\_builder.c@{bin\_builder.c}!build\_csv\_bin@{build\_csv\_bin}}
\index{build\_csv\_bin@{build\_csv\_bin}!bin\_builder.c@{bin\_builder.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bin__builder_8c_a72af491dba4bd97700b63f8dc347d767}\label{bin__builder_8c_a72af491dba4bd97700b63f8dc347d767}} 
\index{bin\_builder.c@{bin\_builder.c}!get\_data\_csv\_bin@{get\_data\_csv\_bin}}
\index{get\_data\_csv\_bin@{get\_data\_csv\_bin}!bin\_builder.c@{bin\_builder.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bin__builder_8c_a18afdb04b391d886f6f9305aa7281eb9}\label{bin__builder_8c_a18afdb04b391d886f6f9305aa7281eb9}} 
\index{bin\_builder.c@{bin\_builder.c}!is\_empty\_line@{is\_empty\_line}}
\index{is\_empty\_line@{is\_empty\_line}!bin\_builder.c@{bin\_builder.c}}
\doxysubsubsection{\texorpdfstring{is\_empty\_line()}{is\_empty\_line()}}
{\footnotesize\ttfamily bool is\+\_\+empty\+\_\+line (\begin{DoxyParamCaption}\item[{FILE $\ast$}]{fp }\end{DoxyParamCaption})}


\begin{DoxyCode}{0}
\DoxyCodeLine{40                             \{}
\DoxyCodeLine{41     \textcolor{keywordtype}{char} c = fgetc(fp);}
\DoxyCodeLine{42     \textcolor{comment}{// end of file}}
\DoxyCodeLine{43     \textcolor{keywordflow}{if}(feof(fp))\{}
\DoxyCodeLine{44          \textcolor{keywordflow}{return} \textcolor{keyword}{true}; }
\DoxyCodeLine{45     \}}
\DoxyCodeLine{46     \textcolor{comment}{// empty line}}
\DoxyCodeLine{47     \textcolor{keywordflow}{if}(c == \textcolor{charliteral}{'\(\backslash\)t'} || c == \textcolor{charliteral}{' '} || c == \textcolor{charliteral}{'\(\backslash\)n'})\{}
\DoxyCodeLine{48         \textcolor{keywordflow}{return} \textcolor{keyword}{true};}
\DoxyCodeLine{49     \}}
\DoxyCodeLine{50     \textcolor{comment}{// not empty line, go back to previous position}}
\DoxyCodeLine{51     \textcolor{keywordflow}{else}\{}
\DoxyCodeLine{52         fseek(fp, -\/1, SEEK\_CUR);}
\DoxyCodeLine{53         \textcolor{comment}{//deprintf("{}is\_empty\_line character (ascii): \%d\(\backslash\)n"{}, c);}}
\DoxyCodeLine{54         \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{55     \}}
\DoxyCodeLine{56 \}}

\end{DoxyCode}
\mbox{\Hypertarget{bin__builder_8c_a3dc244c07dbb044c301d271d33c4d4ab}\label{bin__builder_8c_a3dc244c07dbb044c301d271d33c4d4ab}} 
\index{bin\_builder.c@{bin\_builder.c}!sanatize\_coordinates@{sanatize\_coordinates}}
\index{sanatize\_coordinates@{sanatize\_coordinates}!bin\_builder.c@{bin\_builder.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bin__builder_8c_a4049baa165aaf59a7374b2a1eb72bbf4}\label{bin__builder_8c_a4049baa165aaf59a7374b2a1eb72bbf4}} 
\index{bin\_builder.c@{bin\_builder.c}!write\_to\_csv\_bin@{write\_to\_csv\_bin}}
\index{write\_to\_csv\_bin@{write\_to\_csv\_bin}!bin\_builder.c@{bin\_builder.c}}
